...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-11-2024 a las 20:43:12
...
CREATE TABLE `peliculas` (
  ...
  `año_estreno` varchar(30) NOT NULL,
...
CREATE TABLE `sables` (
  ...
  `afiliacion` varchar(40) NOT NULL,
...
(1, 'Sable de luz de Darth Vader', 'El sable de luz de Darth Vader fue construido después de que Anakin Skywalker se convirtiera en el aprendiz Sith de Darth Sidious. Con su característico color rojo, el sable simboliza la completa caída de Anakin al lado oscuro y fue utilizado para ejecutar la Orden 66, exterminando a la mayoría de los Jedi.', 'Rojo', 'Darth Vader', 'Sith', 'Cristal Kyber corrupto', 'DarthVaderSaber.jpg'),
...
(3, 'Sable de luz de Mace Windu', 'El sable de luz púrpura de Mace Windu es uno de los más distintivos entre los Jedi. Su color refleja el equilibrio que Mace buscaba entre el lado luminoso y el lado oscuro de la Fuerza. Utilizó este sable en muchas batallas, incluida la fatídica confrontación con el Canciller Palpatine.', 'Púrpura', 'Mace Windu', 'Orden Jedi', 'Cristal Kyber', 'macewindusaber.jpg'),
(4, 'Sable de luz de Yoda SW', 'El sable de luz de Yoda es más pequeño que el de un Jedi promedio, adecuado para su estatura. De color verde, el sable fue utilizado por Yoda durante las Guerras Clon y su duelo con el Emperador Palpatine. Es un símbolo del poder y la sabiduría del Maestro Jedi más antiguo y respetado.', 'Verde', 'Yoda', 'Orden Jedi', 'Cristal Kyber', 'yodasaber.webp'),
(5, 'Sable de luz de Obi-Wan Kenobi', 'El sable de luz de Obi-Wan Kenobi es un símbolo de su habilidad y compromiso con la Orden Jedi. Construido por el propio Obi-Wan tras su promoción a Caballero Jedi, este sable de luz azul lo acompañó en algunas de las batallas más importantes de las Guerras Clon, incluyendo su duelo final con Anakin Skywalker en Mustafar. Después de las Guerras Clon, Obi-Wan lo mantuvo hasta su enfrentamiento final con Darth Vader en la Estrella de la Muerte.', 'Azul', 'Obi-Wan Kenobi', 'Orden Jedi', 'Cristal Kyber', 'obiwansaber.jpg'),
(6, 'Sable de luz de Kylo Ren', 'El sable de luz de Kylo Ren es un arma única que refleja su naturaleza inestable y su lucha interna. Su hoja roja, alimentada por un cristal Kyber dañado, emite un resplandor irregular y furioso. El diseño cruzado del sable, con dos pequeñas hojas adicionales que sirven como guarda, es tan inusual como su propietario, quien lo creó tras su caída al lado oscuro. Este sable es un símbolo del poder y la ira de Kylo Ren como líder de la Primera Orden.', 'Rojo', 'Kylo Ren', 'Sith', 'Cristal Kyber dañado', 'kylorensaber.jpg');
